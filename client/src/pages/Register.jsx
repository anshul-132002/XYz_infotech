...
function Register() {
  ...
  const { handleBlur, handleChange, handleSubmit, errors, values, touched } =
    useFormik({
      ...
      onSubmit: async (value, { resetForm }) => {
        try {
          const response = await axios.post(`${API}/api/register`, value);
  ...
  return (
    ...
    >
      ...
      >
        <main className="grid md:grid-cols-2 sm:grid-cols-1 h-screen">
          <div className=" justify-center items-center hidden md:flex">
            <img src="/images/code1.png" alt="code" className="h-lvh" />
          </div>

          <div className=" sm:order-1 md:order-2 flex justify-center items-center border-1  border: 1px solid m-10">
            <form
